...
for runs in range(500):
    for i in range(4):
        ...
        #Level one
        dJdZ1_1 = (W2[0] * dJdZ2_1) * bipolarSigmoidDer(Z2[0]);
        dJdZ1_2 = (W2[1] * dJdZ2_1) * bipolarSigmoidDer(Z2[0]);
        dJdZ1_3 = (W2[2] * dJdZ2_1) * bipolarSigmoidDer(Z2[0]);
        dJdZ1_4 = (W2[3] * dJdZ2_1) * bipolarSigmoidDer(Z2[0]);
